...
// x \in R : x >= 0
#define VIGNETTE_BRIGHTNESS 5.0

// Tint all colors
// [0, 1]^3
#define TINT 0.90, 0.96, 0.93
...
// x \in R : x >= 0
#define FLICKER_STRENGTH 0.0004
...
// [0, 1]
#define NOISE_CONTENT_STRENGTH 0.1
